...
const SLIDEIMAGES = [
  ...
  { src: "view.jpg", alt: "view from our place" },
  { src: "landscape3.jpg", alt: "landscape at sunset" },
  { src: "street4.jpg", alt: "park with attractions" },
  { src: "street8.jpg", alt: "street with threes" },
  { src: "food-jbc.jpg", alt: "typical food" }
];
...
function skipSlide(direction) {
  ...
  sliderElement.src = "src/image/" + newSlideImage.src;
